  ...
  <div class="my">
    ...
    <div class="team">
      <van-row>
        ...
        <van-col span="3" offset="10">{{ team.teams }}</van-col>
      </van-row>
    </div>
    ...
    <div class="team">
      <van-row>
        ...
        <van-col span="3" offset="10">{{ team.direct }}</van-col>
      </van-row>
    </div>
    ...
    <div class="team">
      <van-row>
        ...
        <van-col span="3" offset="10">{{ team.active_teams }}</van-col>
      </van-row>
    </div>
    ...
    <div class="team">
      <van-row>
        ...
        <van-col span="10">团队今日抢单</van-col>
        <van-col span="10" align="right">{{ team.today }}</van-col>
      </van-row>
    </div>
