<template>
    <div class="withdraw">
        ...
        <div class="input">
            ...
            <van-field v-model="params.memo" required clearable label="Memo" placeholder="请输入提现地址的Memo备注" />
        ...
        <div class="submit">
            <van-button round color="linear-gradient(to right, #ba924a, #e9d495)" size="large" :loading="button.loading" :disabled="this.params.amount == '' || this.params.address == '' || this.params.memo == ''" @click="submit">下一步</van-button>
        </div>
